 ...
 */ !(function (t) {
						...
						for (var g = 0; g <= E.length; g++) {
							...
							if (!t || void 0 === r[_]) {
								...
								e && f(r[_]) && f(m) && (m = s(t, e, r[_], m)),
									void 0 !== m && m !== r[_] && (u || ((u = !0), (r = c(r))), (r[_] = m));
							}
						}
				}
			}
	...
	function (t, e, n) {
		...
		window.tram = (function (t) {
			...
			var f = (function (t, e, n) {
				...
				l = {
					...
					'ease-out-back': [
						...
						function (t, e, n, r, i) {
							return (
								void 0 === i && (i = 1.70158), n * ((t = t / r - 1) * t * ((i + 1) * t + i) + 1) + e
							);
						}
					],
					'ease-in-out-back': [
				...
				j = f(function (e) {
					...
					function o(t, e, n) {
						if (t) {
							...
							if (
								...
								return (
									(this.timer = new W({ duration: t, context: this, complete: a })),
									void (this.active = !0)
								);
							if ('string' == o && e) {
								switch (t) {
					...
					function u(t) {
						...
						this.timer && this.timer.destroy(),
							...
							'string' == typeof t
								? ((e = {})[t] = 1)
								: (e = 'object' == (0, r.default)(t) && null != t ? t : this.props),
							p.call(this, e, v),
							d.call(this);
					}
					function f() {
						...
						for (o in t)
							(u = t[o]),
								o in q
									...
									: (g.test(o) && (o = n(o)), o in Q ? (f[o] = u) : (c || (c = {}), (c[o] = u)));
						for (o in f) {
			...
			C.transform &&
				...
				C.transform &&
					C.backface &&
					((q.z = [I, 'translateZ']), (q.rotateZ = [b]), (q.scaleZ = [_]), (q.perspective = [y]));
			var $ = /ms/,
				Z = /s|\./;
			return (t.tram = e);
		})(window.jQuery);
	...
	function (t, e, n) {
										...
										? (function (t) {
												...
												if ((0, f.default)(d)) {
													(0, v.default)(d, function (t, e) {
														...
														if (
															(z(p, u.mediaQueryKeys) || n.dispatch((0, _.mediaQueriesDefined)()),
																...
																a &&
																	t.forEach(function (t, i) {
																		...
																		!(function (t) {
																			...
																			U(E, a) && (b = V(n, b));
																			var T =
																				v.hasBoundaryNodes && i ? m.getClosestElement(i, w) : null;
														...
														(a.actionTypeId === E.ActionTypeConsts.GENERAL_START_ACTION ||
															b(a.actionTypeId)) &&
													...
													var p = function (t) {
															...
															dt(d, function (e, o, c) {
																...
																if (W(p, r.mediaQueryKey)) {
																	...
																	if (
																		l.actionTypeId === E.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION
																	) {
															...
															i.split(' ')
																...
																.forEach(function (t) {
																	...
																	r.addEventListener(t, e),
																		n.dispatch((0, _.eventListenerAdded)(r, [t, e]));
																});
														};
			...
			if (f && f.useFirstGroupAsInitialState) {
				...
				l.forEach(function (t) {
					...
					s.forEach(function (i) {
						...
						_t({
							destination: L({ element: i, actionItem: t, elementApi: m }, o),
							immediate: !0,
							store: e,
							element: i,
							eventId: r,
			...
			(0, v.default)(n, function (t) {
				if (!t.continuous) {
					var n = t.actionListId,
						r = t.verbose;
					mt(t, e),
						r && e.dispatch((0, _.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
				}
			});
		}
		function Et(t) {
			...
			(0, v.default)(u, function (t) {
				...
				if (t.actionListId === o && t.eventId === n && a) {
					...
					mt(t, e),
						t.verbose &&
							e.dispatch((0, _.actionListPlaybackChanged)({ actionListId: o, isPlaying: !1 }));
				}
			});
		}
		function gt(t) {
			...
			return (
				O.forEach(function (t, e) {
					...
					if (p) {
						...
						N({ config: u, event: h, eventTarget: i, elementRoot: v, elementApi: m }).forEach(
							function (u, p) {
								...
								var E = S === e && 0 === p,
									...
									_ = L({ element: u, actionItem: t, elementApi: m }, v);
								_t({
									store: n,
									element: u,
									actionItem: t,
		...
		function _t(t) {
			...
			r.dispatch(
				(0, _.instanceAdded)(
					(0, a.default)(
						{ instanceId: g, elementId: O, origin: R, refType: A, skipMotion: S, skipToValue: n },
						o
					)
				)
			),
				yt(document.body, 'ix2-animation-started', g),
				f
					? (function (t, e) {
			...
			if (W(w, T.mediaQueryKey) && (r || n || i)) {
				...
				if (i) {
					if (h) {
						...
						g &&
							!P &&
							e.dispatch((0, _.actionListPlaybackChanged)({ actionListId: v, isPlaying: !1 }));
					}
					mt(t, e);
				}
			}
		...
		t.exports = (function () {
			...
			return (
				(t.template = function (e, n, r) {
					...
					var i = RegExp(
							[(n.escape || E).source, (n.interpolate || E).source, (n.evaluate || E).source].join(
								'|'
							) + '|$',
							'g'
						),
								...
								(function (t) {
									...
									var n = function n(r) {
										'WF_third_party_cookies_unsupported' === r.data
											? (g(e, n), t(!1))
											: 'WF_third_party_cookies_supported' === r.data && (g(e, n), t(!0));
									};
									(e.onerror = function () {
										g(e, n), t(!1);
									}),
	...
	function (t, e, n) {
		...
		r.define(
			...
			(t.exports = function () {
				...
				function n(n) {
					e &&
						(n.preventDefault(), n.stopPropagation(), n.stopImmediatePropagation(), t.unshift(n));
				}
				function i(n) {
					(function (t) {
						var e = t.target,
	...
	function (t, e, n) {
		...
		(t.exports = function (t, e, n, c) {
			...
			i(n) &&
				...
				t !== r
					? (l ? !h && t[e] && (v = !0) : delete t[e], v ? (t[e] = n) : a(t, e, n))
					: v
					? (t[e] = n)
					: u(e, n);
		...
		(u[l] = !0),
			(t.exports =
				...
				function (t, e) {
					...
					return (
						null !== t
							? ((d.prototype = i(t)), (n = new d()), (d.prototype = null), (n[l] = t))
							: (n = h()),
						void 0 === e ? n : o(n, e)
					);
				});
	...
	function (t, e, n) {
		...
		e.ixSession = function () {
			...
			switch (e.type) {
				...
				case v:
					for (
						var S = e.payload, R = S.width, x = S.mediaQueries, N = x.length, C = null, L = 0;
						L < N;
						L++
					) {
						var P = x[L],
	...
	function (t, e, n) {
		...
		t.exports = function (t, e, n, E, g, _) {
			...
			if (w && !T)
				return _ || (_ = new r()), m || f(t) ? i(t, e, n, E, g, _) : o(t, e, I, n, E, g, _);
			if (!(n & l)) {
		...
		t.exports = function (t, e, n, a, u, c) {
			...
			if (E && !g) {
				...
				I != b &&
					'constructor' in t &&
					'constructor' in e &&
					!('function' == typeof I && I instanceof I && 'function' == typeof b && b instanceof b) &&
					(E = !1);
			}
	...
	function (t, e, n) {
		...
		Object.defineProperty(e, '__esModule', { value: !0 }),
			...
			(e.reifyState = function () {
				...
				return {
					ixData: { events: e, actionLists: n, eventTypeMap: i, mediaQueries: o, mediaQueryKeys: a }
				};
			}),
			...
			(e.getDestinationValues = function (t) {
				...
				switch (i) {
					...
					case it:
						...
						if (v === W) {
							var I = s(e, P);
							f(e, P, ''), (m = l(e, 'offsetHeight')), f(e, P, I);
						}
							...
							switch (u) {
								case it:
									var s = r.config,
										...
										h = n.widthValue,
										E = n.heightValue;
									void 0 !== h && (d === W && (d = 'px'), xt(t, L, o), a(t, L, h + d)),
									...
									xt(t, g, o),
										a(
											...
											I >= 1
												...
												: 'rgba('.concat(_, ',').concat(m, ',').concat(y, ',').concat(I, ')')
										);
									break;
								default:
									var b = c.unit,
			...
			(e.cleanupHTMLElement = function (t, e, n) {
				...
				i(t, V) && Pt({ effect: Nt, actionTypeId: o, elementApi: n })(t);
			}),
			...
			(e.reduceListToGroup = function (t) {
				...
				return (
					...
					(0, p.setIn)(
						r,
						['actionLists'],
						(0, c.default)({}, e.id, { id: e.id, actionItemGroups: [{ actionItems: a }] })
					)
				);
			}),
		...
		var f = s(n(270)),
			...
			lt = Object.freeze(
				((r = {}), (0, c.default)(r, ot, D), (0, c.default)(r, at, M), (0, c.default)(r, ut, j), r)
			),
			dt = Object.freeze(
				((i = {}),
		...
		function _t(t) {
			...
			if (Array.isArray(s) && s.length > 0)
				return s.reduce(function (t, e) {
					return t.concat(
						_t({ config: { target: e }, event: o, eventTarget: a, elementRoot: u, elementApi: c })
					);
				}, []);
		...
		var r = n(4),
			...
			b = function (t, e) {
				...
				if (_ && !y)
					...
					for (
						var k = (w - I) / b, G = _.config.easing, X = h(G, k, f), U = 0, V = a.length;
						U < V;
						U++
					) {
						var W = a[U],
					...
					handler: function (t) {
						...
						return (
							...
							(u !== h.EventBasedOn.ELEMENT || S || S !== a.elementHovered) &&
								((w = f ? 1 - w : w), e.dispatch((0, g.parameterChanged)(A, w))),
				...
				(0, o.default)(r, G, {
					...
					handler: function (t) {
						...
						if (d === h.EventBasedOn.VIEWPORT) {
							var A = w ? u / s : c / f;
							return (
								A !== o.scrollPercent && n.dispatch((0, g.parameterChanged)(v, A)),
								{ scrollPercent: A }
							);
						}
						var S = Y(i, v),
						...
						return (
							D !== o.scrollPercent && n.dispatch((0, g.parameterChanged)(S, D)),
							{ scrollPercent: D }
						);
					}
				}),
		...
		r.define(
			...
			(t.exports = function (t) {
				...
				function g(e) {
					...
					if (
						!(r.env('design') || (window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className)))
					) {
						var s,
							l =
								((s = a),
			...
			(t.exports = function (t) {
				...
				function r(e) {
					...
					function c(t) {
						var e = t.touches;
						(e && e.length > 1) ||
							((o = !0), e ? ((a = !0), (r = e[0].clientX)) : (r = t.clientX), (i = r));
					}
					function s(e) {
						if (o) {
							...
							f.el.on(
								...
								(function (t) {
									return function (e) {
										if (!n && t.open)
											switch (
												((t.selectedIdx = t.links.index(document.activeElement)), e.keyCode)
											) {
												case o.HOME:
													if (!t.open) return;
			...
			(t.exports = function (t, e) {
				...
				function y(e, n) {
							...
							!(function (e, n) {
								...
								function O(t) {
									var r = t.responseJSON && t.responseJSON.msg,
										i = y;
									'string' == typeof r && 0 === r.indexOf('InvalidFileTypeError')
										? (i = m)
										: 'string' == typeof r && 0 === r.indexOf('MaxFileSizeError') && (i = _),
										p.text(i),
										f.removeAttr('data-value'),
										f.val(''),
										a.toggle(!1),
					...
					(i.handler = null),
						...
						_.test(s) ? (i.handler = A) : s || (o ? (i.handler = w) : m());
				}
				function I(t) {
								...
								(r =
									...
									(function (t, e, n, r) {
										...
										'password' === e
											...
											? r
												? v.test(t.attr('type')) &&
												  (h.test(r) || (i = 'Please enter a valid email address for: ' + n))
										...
										f.on(
											...
											f.on('change', p + ' form input[type="radio"]', function (e) {
												...
												n.hasClass('w-radio-input') ||
													n.siblings('.w-radio-input').addClass('w--redirected-checked');
											}),
											e.forEach(function (e) {
												...
												f.on(
													'focus',
													p + ' form input[type="'.concat(i, '"]:not(') + o + ')',
													function (e) {
...
Webflow.require('ix2').init({
	events: {
		'e-2': {
			...
			target: { id: '6201f3e1c045ec05ad7060a5', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec05ad7060a5', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
		...
		'e-5': {
			...
			target: {
				...
				originalId: '6201f3e1c045ec05ad7060a5|500c8e06-8d99-7339-b5f9-163ec5d1b733',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-7': {
			...
			target: {
				...
				originalId: '6201f3e1c045ec05ad7060a5|439c0476-e606-1dd6-4d70-ec295876f60b',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-12': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6201f3e1c045ec26e67060b2', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec26e67060b2', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-16': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6201f3e1c045ec565a7060a6', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec565a7060a6', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-20': {
			...
			target: {
				selector: '.nav-link',
				originalId: 'f09f4fea-e7a0-eea2-b5ac-d06cfbe9e7f9',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-28': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620aeb767c8ae13db28e2bfd', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620aeb767c8ae13db28e2bfd', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-33': {
			...
			mediaQueries: ['main', 'medium'],
			target: {
				selector: '.blur-on-scroll',
				originalId: '620aeb767c8ae13db28e2bfd|a0e2e27c-b866-980f-54d6-c5c3030b322e',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-34': {
			...
			mediaQueries: ['main'],
			target: {
				selector: '.fade-in-on-scroll---first',
				originalId: '620aeb767c8ae13db28e2bfd|dea15678-4c4a-b22f-dc43-608a454d0b98',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-36': {
			...
			mediaQueries: ['main'],
			target: {
				selector: '.fade-in-on-scroll---second',
				originalId: '620aeb767c8ae13db28e2bfd|dea15678-4c4a-b22f-dc43-608a454d0b98',
				appliesTo: 'CLASS'
			},
			targets: [
		...
		'e-39': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620c4bd014d32808b6bc27c6', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620c4bd014d32808b6bc27c6', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-44': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620c59e977a34823289e2926', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620c59e977a34823289e2926', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-48': {
			...
			target: {
				selector: '.fade-in-on-scroll---third',
				originalId: '620c4bd014d32808b6bc27c6|007265d8-32db-da16-075a-36319b9ca9ad',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-51': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620d74f3ed1287f9ca0162f8', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620d74f3ed1287f9ca0162f8', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-56': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620d81f067fd2473b266005f', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620d81f067fd2473b266005f', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-61': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620d828ea8f27639e5e5098a', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620d828ea8f27639e5e5098a', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-66': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620d933760644d83fab8cde0', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620d933760644d83fab8cde0', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-71': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620d94599d114376674f761b', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620d94599d114376674f761b', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-76': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620db520dec86fb2cd614954', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620db520dec86fb2cd614954', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-81': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620db6cb91cc4efb2325da9a', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620db6cb91cc4efb2325da9a', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-86': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620db8a39d11435857508730', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620db8a39d11435857508730', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-91': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620dbf7ba63c5f05959eafb8', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620dbf7ba63c5f05959eafb8', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-96': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620dc0165653b70f3bb8e408', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620dc0165653b70f3bb8e408', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-101': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620dc42260644d7560ba1caa', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620dc42260644d7560ba1caa', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-106': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '620dc5690e5bc330b5a33ee0', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '620dc5690e5bc330b5a33ee0', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-109': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6212c1d8185513c0cff37dc3', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6212c1d8185513c0cff37dc3', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-113': {
			...
			mediaQueries: ['main'],
			target: {
				selector: '.horizontal-gallery-wrapper',
				originalId: '6212c1d8185513c0cff37dc3|dd7f48b7-20cf-0eb1-f4a4-75e0aaf79ee3',
				appliesTo: 'CLASS'
			},
			targets: [
				{
		...
		'e-115': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6212c8f39e8d4c26c7b03737', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6212c8f39e8d4c26c7b03737', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-120': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6212d57838bf031700d1366a', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6212d57838bf031700d1366a', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-125': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6212e6b9c1efc14f22b6e551', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6212e6b9c1efc14f22b6e551', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-129': {
			...
			mediaQueries: ['main', 'medium'],
			target: { id: '6201f3e1c045ec1ffb7060a9', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec1ffb7060a9', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: [
				{
					continuousParameterGroupId: 'a-7-p',
					smoothing: 50,
		...
		'e-135': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6201f3e1c045ec97e47060ae', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec97e47060ae', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-140': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6201f3e1c045ec40b47060ab', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec40b47060ab', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-145': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '6201f3e1c045ec86357060b1', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '6201f3e1c045ec86357060b1', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-150': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '62155bd0e8fd5deda2d3dcf0', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '62155bd0e8fd5deda2d3dcf0', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-155': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '62155fa0d6c45283c40c7f43', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '62155fa0d6c45283c40c7f43', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
		...
		'e-160': {
			...
			mediaQueries: ['main', 'medium', 'small', 'tiny'],
			target: { id: '621560fd8cf77257c27182ef', appliesTo: 'PAGE', styleBlockIds: [] },
			targets: [{ id: '621560fd8cf77257c27182ef', appliesTo: 'PAGE', styleBlockIds: [] }],
			config: {
				loop: false,
				playInReverse: false,
				scrollOffsetValue: null,
	...
	actionLists: {
					...
					actionItems: [
						{
							...
							config: {
								...
								target: {
									...
									selectorGuids: ['e625c1da-337d-7a1f-e26d-588381655896']
								},
								value: 'flex'
							}
						},
						{
							...
							config: {
								...
								target: {
									selector: '.load-first',
									selectorGuids: ['ccd31aaa-df85-174e-1254-40b2b3425b3e']
								},
								value: 0,
								unit: ''
							}
						},
						{
							...
							config: {
								...
								duration: 500,
								target: {
									selector: '.load-second',
									selectorGuids: ['b0f3d300-a65e-4e80-8bf2-59bd1cfa0748']
								},
								value: 0,
								unit: ''
							}
						},
						{
							...
							config: {
								...
								target: {
									selector: '.load-third',
									selectorGuids: ['6ba923fa-2eb8-acb7-a961-92700c41e48a']
								},
								value: 0,
								unit: ''
							}
					...
					actionItems: [
						{
							...
							config: {
								...
								target: {
									selector: '.loader',
									selectorGuids: ['375dcd4f-a849-97b6-aeae-019ede1eef5e']
								},
								value: 0,
								unit: ''
							}
					...
					actionItems: [
						{
							id: 'a-4-n',
							actionTypeId: 'STYLE_OPACITY',
							config: { delay: 0, easing: '', duration: 250, target: {}, value: 0, unit: '' }
						}
					]
				},
				{
					...
					actionItems: [
						{
							id: 'a-4-n-3',
							actionTypeId: 'GENERAL_DISPLAY',
							config: { delay: 0, easing: '', duration: 0, target: {}, value: 'none' }
						}
					]
				}
			],
							...
							actionItems: [
								{
									...
									config: {
										...
										target: {
											selector: '.navbar-bg',
											selectorGuids: ['640be50e-2ec6-cc3a-ce83-1cf6563af073']
										},
										value: 0,
										unit: ''
									}
					...
					actionItems: [
						{
							...
							config: {
								...
								target: {
									...
									selector: '.dropdown-screen',
									selectorGuids: ['10024253-5a92-34d1-a8a7-3c81b285e74d']
								},
								value: 0,
								unit: ''
							}
						},
						{
							...
							config: {
								...
								target: {
									...
									selectorGuids: ['257c07de-c9db-c86a-0a53-6ab5d6064f8c']
								},
								value: 0,
								unit: ''
							}
		...
		'a-10': {
							...
							actionItems: [
								{
									...
									config: {
										...
										target: {
											useEventTarget: true,
											id: '620aeb767c8ae13db28e2bfd|5da35a33-710f-a584-da7c-07e11a67b222'
										},
										filters: [{ type: 'blur', filterId: '4b2c', value: 5, unit: 'px' }]
									}
								}
							]
						},
							...
							actionItems: [
								{
									...
									config: {
										...
										filters: [{ type: 'blur', filterId: 'dcb3', value: 0, unit: 'px' }]
									}
								}
							]
						},
							...
							actionItems: [
								{
									...
									config: {
										...
										filters: [{ type: 'blur', filterId: '9071', value: 0, unit: 'px' }]
									}
								}
							]
						},
							...
							actionItems: [
								{
									...
									config: {
										...
										filters: [{ type: 'blur', filterId: '9c21', value: 5, unit: 'px' }]
									}
								}
							]
						}
			...
			createdOn: 1644890438718
		},
		'a-11': {
			id: 'a-11',
			title: 'Fade In On Scroll - First',
			actionItemGroups: [
				{
					actionItems: [
						{
							...
							config: {
								...
								target: {
									useEventTarget: true,
									id: '620aeb767c8ae13db28e2bfd|dea15678-4c4a-b22f-dc43-608a454d0b98'
								},
								value: 0,
								unit: ''
							}
			...
			useFirstGroupAsInitialState: true,
			createdOn: 1644894348717
		},
		'a-12': {
			id: 'a-12',
			title: 'Fade In On Scroll - Second',
			actionItemGroups: [
				{
					actionItems: [
						{
		...
		'a-14': {
			id: 'a-14',
			title: 'Horizontal Image Gallery Scrolling',
			continuousParameterGroups: [
				{
					id: 'a-14-p',
					type: 'SCROLL_PROGRESS',
							...
							actionItems: [
								{
									...
									config: {
										...
										target: {
											useEventTarget: 'CHILDREN',
											selector: '.horizontal-gallery-section',
											selectorGuids: ['3134bdc3-fcf9-117f-74b5-4538587966c2']
										},
										xValue: 10,
										xUnit: '%',
										yUnit: 'PX',
